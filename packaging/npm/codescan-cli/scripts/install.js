...
function log(msg)  { process.stdout.write('@webnori/codescan-cli: ' + msg + '\n'); }
function warn(msg) { process.stderr.write('@webnori/codescan-cli: ' + msg + '\n'); }
...
function get(url) {
    return new Promise((resolve, reject) => {
        const opts = { headers: { 'User-Agent': 'webnori-codescan-cli-installer' } };
